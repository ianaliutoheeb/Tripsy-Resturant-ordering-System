     ...
     <div class="header">
         ...
         <div class="navbar-header">
                 <a class="navbar-brand" href="dashboard.php">
                     ...
                     <span> <b style = " color:Red;font-weight: bolder;">TRISPY FAST FOOD </b></span>
                 </a>
             </div>
            ...
            <div class="container-fluid">
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header" style = " background:Red;font-weight: bolder;">
                                ...
                                <form action='' method='post' >
                                    ...
                                    <div class="form-actions">
                                        <input type="submit" name="submit" class="btn btn-primary" value="Save" style = " background:Red;"> 
